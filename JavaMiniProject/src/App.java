    ...
    public App() {
        ...
        AddButton.addActionListener(e -> {
            ...
            select.addActionListener(e15 -> {
                ...
                newEntryInformation.setSize(300, 420);
                ...
                if("Planet".equals(type)){
                    ...
                    informationTextArea.setBounds(90, 110, 100, 150);
                    informationTextArea.setLineWrap(true);
                    informationTextArea.setWrapStyleWord(true);
                    submit.setBounds(25, 270, 100, 30);
                    cancel.setBounds(130, 270  , 100, 30);
                    newEntryInformation.add(dialogPanel);

                    cancel.addActionListener(e15110 -> {
                    ...
                    cancel.addActionListener(e1516 -> {
                        newEntryInformation.setVisible(false);
                        typeDialog.setVisible(false);
                    });
                    ...
                    cancel.addActionListener(e1513 -> {
                        newEntryInformation.setVisible(false);
                        typeDialog.setVisible(false);
                    });
                    ...
                    cancel.addActionListener(e1518 ->{
                        newEntryInformation.setVisible(false);
                        typeDialog.setVisible(false);
                    });
